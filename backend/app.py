...
CORS(app, origins=['http://localhost:3000', 'https://yuta-gam-app.vercel.app', 'https://yuta-gam-app-70ca7e13f399.herokuapp.com'], supports_credentials=True)  # 指定したオリジンからのリクエストを許可するCORSの設定
